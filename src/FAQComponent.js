      ...
      return(
        ...
        <div className="faq">
          <ul className="collapsible deep-orange darken-4" data-collapsible="accordion">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
                <h5>Do you have vegetarian pizza?</h5>
              </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
                <h5> Do you have gluten free dough? </h5>
              </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
                <h5> Do you have family specials? </h5>
              </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
                <h5> Problem with your call? </h5>
              </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
                  <h5>Why is my call not being answered?/Why am I on hold for so long?/Why is there a busy signal when I call? </h5>
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
                <h5>  Why is my delivery taking so long? </h5>               </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5>  How spicy is the Blazing Sauce?</h5>               </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5>  Do all your pizzas come with tomato sauce?</h5>               </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5>  Does your pesto have any nuts or cheese?</h5>               </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5>  What is your delivery area?</h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5>  How long does a pizza take to make?</h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5>  How are your wings made/served? </h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5> Can I do half-and-half pizzas?</h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5> Can I substitute ingredients on your specialty pizzas?</h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5> What discounts can you offer?</h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
            ...
            <li>
              <div className="collapsible-header deep-orange darken-4">
              <h5> What size pizzas do you have, and how many slices are in each?</h5> </div>
              <div className="collapsible-body red darken-4">
                <div class="container">
